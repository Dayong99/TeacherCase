      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          <router-link to="/profile/index">
            <el-dropdown-item v-show="adminShow" style="border-bottom:1px solid #909399;">
              {{ $t('navbar.profile') }}
            </el-dropdown-item>
          </router-link>
          <el-dropdown-item>
...
return {
  ...
  computed: {
    ...
    avatar() {
      return require(`@/assets/avatar/gaOngJwsRYRaVAuXXcmB.png`)
    },
    username() {
  ...
  created(){
    if(this.$store.state.account.user.position=='管理员'){
...
.el-dropdown-menu__item--divided {
  border-top:1px solid #909399!important;
}
.navbar {
  height: 50px;
  overflow: hidden;
