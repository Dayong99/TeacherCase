  ...
  <div>
    ...
    >
      <div slot="title" class="dialog-title">
        <i class="iconfont icon-zhuce nav-operation"></i>
        <span>批量注册</span>
      </div>
      <el-form
        ref="form"
      ...
      >
        ...
        <el-form-item label="学制" prop="duration">
          <el-input v-model="oneBatch.duration" size="small" />
        </el-form-item>
  ...
  methods: {
    ...
    submitForm() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          // create
          this.$post("case/user/addStudents", { ...this.oneBatch }).then(() => {
