<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="queryParams.typeName" placeholder="类型名称" class="filter-item search-item" clearable @clear="reset"/>
...
export default {
  ...
  methods: {
    ...
    fetch(params = {}) {
      ...
      this.loading = true;
      this.$get("caseteach/case-type-info", {
        ...params,
      }).then((r) => {
    ...
    delete(typeIds) {
      this.loading = true;
      typeIds.forEach((e) => {
        this.$delete(`caseteach/case-type-info/?jobId=${e}`).then(() => {
          this.$message({
