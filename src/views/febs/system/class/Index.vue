<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="queryParams.className" placeholder="班级名称" class="filter-item search-item" />
    ...
    >
      ...
      >
        <template slot-scope="{row}">
          <i class="el-icon-s-tools table-operation purple" @click="edit(row)" title="修改" />
...
import classEdit from "./EditClass";

export default {
  name: "CASE",
  components: { Pagination, classEdit },
  data() {
    return {
      dialog: {
        isVisible: false,
  ...
  methods: {
    ...
    delete(classIds) {
      this.loading = true;
      classIds.forEach((e) => {
        this.$delete(`caseteach/class/?ids=${e}`).then(() => {
          this.$message({
