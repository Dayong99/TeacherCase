    ...
    <el-row :gutter="10">
          ...
          <div class="filter-container">
            ...
            <el-dropdown v-has-any-permission="['menu:add','menu:delete','menu:export']" trigger="click" class="filter-item">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-has-permission="['menu:deleteSelected']" @click.native="deleteMenu">{{ $t('table.delete') }}</el-dropdown-item>
      ...
      <el-col :xs="24" :sm="12">
        <el-card class="box-card">
          ...
          <div>
            <el-form class="case-form" ref="form" :model="menu" :rules="rules" label-position="right" label-width="100px">
