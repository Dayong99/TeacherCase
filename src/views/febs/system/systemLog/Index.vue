<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="queryParams.caseName" placeholder="操作人" class="filter-item search-item" />
    ...
    >
      ...
      >
        <template slot-scope="{row}">
          <i class="el-icon-delete table-operation mr0" @click="singleDelete(row)" title="删除" />
        </template>
      </el-table-column>
    </el-table>
    <pagination
