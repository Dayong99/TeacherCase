    ...
    <el-row :gutter="10">
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          ...
          <span>{{ $t('table.user.username') +'：' }}</span>
          {{ user.username }}
        </div>
      </el-col>
      <el-col :xs="24" :sm="12">
    ...
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          ...
          {{ user.status === '1' ? $t('common.status.valid') : $t('common.status.invalid') }}
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          ...
          <span>{{ $t('table.user.modifyTime') +'：' }}</span>
          {{ user.modifyTime }}
        </div>
      </el-col>
    </el-row>
